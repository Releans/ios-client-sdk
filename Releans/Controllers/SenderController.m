                ...
                completionBlock:(CompletedGetSenderNameDetails) onCompleted
{
    ...
    [_queryBuilder appendString: @"/sender/view/"];
                ...
                completionBlock:(CompletedPostCreateSenderName) onCompleted
{
    ...
    NSError* _validationError = nil;
    if (senderName == nil)
        _validationError = [[APIError alloc] initWithReason: @"The parameter 'senderName' is a required parameter and cannot be nil."
                                                    andContext:nil];
    if(_validationError != nil)
        onCompleted(NO,nil,nil,_validationError);
    ...
    //prepare query string for API call
    NSMutableString* _queryBuilder = [NSMutableString stringWithString: _baseUri]; 
    [_queryBuilder appendString: @"/sender/create"];
    ...
    {
        [_request setBody: [senderName dataUsingEncoding:NSUTF8StringEncoding]]; //set request body
        [_request setQueryUrl: _queryUrl]; //set request url        
        [_request setHeaders: _headers]; //set request headers
...
- (void) getAllSendersWithCompletionBlock:(CompletedGetAllSenders) onCompleted
{
    ...
    //prepare query string for API call
    NSMutableString* _queryBuilder = [NSMutableString stringWithString: _baseUri]; 
    [_queryBuilder appendString: @"/sender"];
